...
describe("application schema", () => {
  ...
  test.each(orderContractFixtures.valid)("accepts cross-repository order fixture: $name", (fixture) => {
    const result = validateApplicationInput(
  ...
  test.each(orderContractFixtures.invalid)("rejects cross-repository order fixture: $name", (fixture) => {
    const result = validateApplicationInput(
      { ...base, type: "order", ...fixture },
      { allowedProductSlugs: new Set(orderContractFixtures.allowedProductSlugs) },
    );
